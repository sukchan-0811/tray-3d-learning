...
from dataset import ShapeNet, Tray3d
...
def test_tray(model, params, save=True):
    if save:
        exp_dir = os.path.join(params.result_dir, params.exp_name)
        ...
        for p, c in test_dataloader:
            ...
            for i in range(len(c)):
                ...
                if save:
                    ...
                    # export_ply(os.path.join(input_dir, '{:03d}.ply'.format(index)), input_pc)
...
def test(params, save=False):
    ...
    elif params.category == 'tray':
        avg_l1_cd, avg_l2_cd, avg_f_score = test_tray(model, params, save)
...
def test_emd(params):
    ...
    if params.category == 'tray':
        print('Emd evaluation is not supported in Tray3d.')
        return
...
if __name__ == '__main__':
    ...
    parser.add_argument('--category', type=str, default='tray', help='Category of point clouds')
    ...
    parser.add_argument('--save', type=bool, default=True, help='Saving test result')
